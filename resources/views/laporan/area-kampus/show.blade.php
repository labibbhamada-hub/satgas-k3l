                ...
                <div class="card rounded-0 mb-3">
                    <div class="card-content">
                        <div class="card-body text-center">
                            <h5 class="card-title">Terima Kasih Telah Melapor</h5>
                            <p class="card-text">
                                Kami menghargai kepedulian Anda terhadap keselamatan di lingkungan kampus. Laporan yang
                                telah Anda kirim akan segera ditinjau oleh Tim Satgas K3L dan diproses sesuai prosedur
                                yang berlaku.
                            </p>
                        </div>
                        <img src="{{ asset('storage/asset/laporan-kampus-success.png') }}" class="img-fluid"
