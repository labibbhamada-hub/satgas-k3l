            ...
            <div class="container d-flex justify-content-center justify-content-md-between">
                <div class="contact-info d-flex align-items-center">
                    <i class="bi bi-envelope d-flex align-items-center">
                        <a href="mailto:contact@example.com">satgask3l@bhamada.ac.id</a>
                    </i>
        ...
        <div class="branding d-flex align-items-cente">
            <div class="container position-relative d-flex align-items-center justify-content-between">
                <a href="index.html" class="logo d-flex align-items-center">
                    ...
                    <h1 class="sitename">SATGAS K3L</h1>
                </a>
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li>
                            <a href="about.html">Lapor Indisiden</a>
                        </li>
                        <li>
                        ...
                        <!-- Button Login -->
                        <li>
                            <a href="{{ url('login') }}" class="btn btn-primary nav-btn">
    ...
    <main class="main">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-content">
                            ...
                            <h1 data-aos="fade-right" data-aos-delay="300">
                                Mewujudkan Lingkungan <span class="highlight">Kampus Aman</span> dengan Budaya K3L
                            </h1>
                            <p class="hero-description" data-aos="fade-right" data-aos-delay="400">
                                Satgas K3L hadir untuk menjaga keamanan, keselamatan, kesehatan, dan lingkungan kampus
                                melalui sistem pelaporan, edukasi, dan respons cepat terhadap setiap potensi bahaya.
                            </p>
                            <div class="hero-stats mb-4" data-aos="fade-right" data-aos-delay="500">
                                ...
                                <div class="stat-item">
                                    <h3><span data-purecounter-start="0" data-purecounter-end="25"
                                            data-purecounter-duration="2" class="purecounter"></span>+</h3>
                                ...
                                <div class="stat-item">
                                    <h3><span data-purecounter-start="0" data-purecounter-end="10"
                                            data-purecounter-duration="2" class="purecounter"></span>+</h3>
                                    <p>Tim Satgas Aktif</p>
                                </div>
                            </div>
                            <div class="hero-actions" data-aos="fade-right" data-aos-delay="600">
                                <a href="/laporan" class="btn btn-primary">Laporkan Insiden</a>
                                <a href="/edukasi" class="btn btn-outline">
                            ...
                            <div class="emergency-contact" data-aos="fade-right" data-aos-delay="700">
                                ...
                                <div class="emergency-info">
                                    <small>Kontak Darurat K3L</small>
                                    <strong>0812-XXXX-XXXX (WhatsApp)</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="hero-visual" data-aos="fade-left" data-aos-delay="400">
                            <div class="main-image">
                                <img src="{{ asset('asset/safety.svg') }}" alt="Safety First" class="img-fluid">
                                <div class="floating-card appointment-card">
                                    <div class="card-icon">
                                        <i class="bi bi-calendar-check"></i>
                                    </div>
                                    <div class="card-content">
                                        <h6>Kegiatan Terdekat</h6>
                                        <p>Simulasi Kebakaran</p>
                                        <small>Hari ini, 14:00</small>
                                    </div>
                                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade-right" data-aos-delay="200">
                        <div class="about-content">
                            <h2 class="section-heading">Tentang Satgas K3L</h2>
                            <p class="lead-text">
                                Satgas K3L (Keamanan, Keselamatan, Kesehatan, dan Lingkungan) hadir untuk menciptakan
                                lingkungan kampus yang aman, sehat, dan kondusif melalui sistem pelaporan dan penanganan
                                insiden secara terpadu.
                            </p>
                            <p>
                                Kami berfokus pada pencegahan, edukasi, dan respons cepat terhadap setiap potensi bahaya
                                di lingkungan kampus. Dengan dukungan teknologi dan partisipasi seluruh civitas
                                akademika, Satgas K3L berkomitmen menjaga keselamatan bersama.
                            </p>
                            <div class="stats-grid">
                                ...
                                <div class="stat-item">
                                    ...
                                    <div class="stat-label">Tim Satgas</div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                        <div class="about-visual">
                            <div class="main-image">
                                <img src="{{ asset('asset/safety.svg') }}" alt="Modern medical facility"
                                    class="img-fluid">
                            </div>
                            <div class="floating-card">
                                <div class="card-content">
                                    ...
                                    <div class="card-text">
                                        <h4>Layanan K3L</h4>
                                        <p>Siap menangani laporan dan kondisi darurat</p>
                                    </div>
                                </div>
                            </div>
                            <div class="experience-badge">
                                <div class="badge-content">
                                    <span class="years">K3L</span>
                                    <span class="text">Aman • Sehat • Lestari</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="featured-departments" class="featured-departments section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Fitur Utama K3L</h2>
                <p>Sistem terpadu untuk pelaporan, pemantauan, dan edukasi keselamatan di lingkungan kampus</p>
            </div>
            <!-- End Section Title -->
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                <div class="row g-5">
                        ...
                        <div class="specialty-card">
                            <div class="specialty-content">
                                <div class="specialty-meta">
                                    <span class="specialty-label">Pelaporan Insiden</span>
                                </div>
                                <h3>Pelaporan Insiden</h3>
                                <p>Laporkan kejadian kecelakaan, potensi bahaya, atau kondisi tidak aman secara cepat
                                    dan mudah melalui sistem.</p>
                                <div class="specialty-features">
                                    <span>
                                        <i class="bi bi-check-circle-fill"></i>Form laporan online
                                    </span>
                                    <span>
                                        <i class="bi bi-check-circle-fill"></i>Upload foto kejadian
                                    </span>
                                </div>
                                <a href="/laporan" class="specialty-link">
                                    Laporkan Sekarang <i class="bi bi-arrow-right"></i>
                                </a>
                            </div>
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="specialty-card">
                            <div class="specialty-content">
                                <div class="specialty-meta">
                                    <span class="specialty-label">Monitoring Laporan</span>
                                </div>
                                <h3>Monitoring Laporan</h3>
                                <p>Pantau status laporan secara real-time dan pastikan setiap insiden ditangani dengan
                                    cepat.</p>
                                <div class="specialty-features">
                                    <span>
                                ...
                                <a href="/dashboard" class="specialty-link">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="department-highlight">
                            ...
                            <h4>Edukasi K3L</h4>
                            <p>Materi pembelajaran untuk meningkatkan kesadaran keselamatan.</p>
                            <ul class="highlight-list">
                                <li>Artikel keselamatan</li>
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="department-highlight">
                            ...
                            <h4>Inspeksi Lingkungan</h4>
                            <p>Pemantauan kondisi lingkungan untuk mencegah potensi bahaya.</p>
                            <ul class="highlight-list">
                                <li>Identifikasi risiko</li>
                                <li>Audit keselamatan</li>
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                        <div class="department-highlight">
                            ...
                            <p>Respons cepat terhadap kejadian darurat di lingkungan kampus.</p>
                            <ul class="highlight-list">
                                <li>Evakuasi</li>
                                <li>Penanganan awal</li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            <div class="emergency-content">
                                <h3>Layanan Darurat K3L</h3>
                                <p>Tim Satgas K3L siap merespons laporan dan kondisi darurat di lingkungan kampus.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 text-lg-end">
                            <a href="tel:0812XXXXXXX" class="emergency-btn">
                                <i class="bi bi-telephone-fill"></i>
